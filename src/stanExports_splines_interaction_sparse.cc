...
#include "stanExports_splines_interaction_sparse.h"

RCPP_MODULE(stan_fit4splines_interaction_sparse_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_splines_interaction_sparse")
