...
namespace model_splines_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_splines_fixed");
    reader.add_event(138, 136, "end", "model_splines_fixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_splines_fixed
  : public stan::model::model_base_crtp<model_splines_fixed> {
private:
        int n;
        int K;
        int p;
...
public:
    model_splines_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_splines_fixed_namespace::model_splines_fixed";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_splines_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_splines_fixed_namespace::model_splines_fixed stan_model;
#ifndef USING_R
