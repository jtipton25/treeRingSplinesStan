...
#include "stanExports_splines_interaction.h"

RCPP_MODULE(stan_fit4splines_interaction_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_splines_interaction")
