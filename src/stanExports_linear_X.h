...
namespace model_linear_X_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_linear_X");
    reader.add_event(62, 60, "end", "model_linear_X");
    return reader;
}
#include <stan_meta_header.hpp>
class model_linear_X
  : public stan::model::model_base_crtp<model_linear_X> {
private:
        int K;
        int n;
        int n_tree;
        ...
        matrix_d X_int_pred;
public:
    model_linear_X(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_linear_X_namespace::model_linear_X";
        ...
        try {
            ...
            check_greater_or_equal(function__, "n_tree", n_tree, 1);
            current_statement_begin__ = 7;
            validate_non_negative_index("X_int", "n", n);
            validate_non_negative_index("X_int", "n_tree", n_tree);
            context__.validate_dims("data initialization", "X_int", "matrix_d", context__.to_vec(n,n_tree));
            X_int = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, n_tree);
            vals_r__ = context__.vals_r("X_int");
            pos__ = 0;
            size_t X_int_j_2_max__ = n_tree;
            size_t X_int_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < X_int_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_int_j_1_max__; ++j_1__) {
                    X_int(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("X_int_pred", "n_pred", n_pred);
            validate_non_negative_index("X_int_pred", "n_tree", n_tree);
            context__.validate_dims("data initialization", "X_int_pred", "matrix_d", context__.to_vec(n_pred,n_tree));
            X_int_pred = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_pred, n_tree);
            vals_r__ = context__.vals_r("X_int_pred");
            pos__ = 0;
            size_t X_int_pred_j_2_max__ = n_tree;
            size_t X_int_pred_j_1_max__ = n_pred;
            for (size_t j_2__ = 0; j_2__ < X_int_pred_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_int_pred_j_1_max__; ++j_1__) {
                    X_int_pred(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("beta_int", "n_tree", n_tree);
            num_params_r__ += n_tree;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("beta_int", "n_tree", n_tree);
        context__.validate_dims("parameter initialization", "beta_int", "vector_d", context__.to_vec(n_tree));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_int(n_tree);
        size_t beta_int_j_1_max__ = n_tree;
        for (size_t j_1__ = 0; j_1__ < beta_int_j_1_max__; ++j_1__) {
            beta_int(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(beta_int);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            // model parameters
            current_statement_begin__ = 19;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_int;
            (void) beta_int;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_int = in__.vector_constrain(n_tree, lp__);
            else
                beta_int = in__.vector_constrain(n_tree);
            current_statement_begin__ = 22;
            ...
            lp_accum__.add(normal_log<propto__>(beta_int, 0, 10));
            current_statement_begin__ = 36;
            lp_accum__.add(normal_log<propto__>(beta, 0, 10));
            current_statement_begin__ = 39;
            lp_accum__.add(cauchy_log<propto__>(sigma_y, 0, 2.5));
            current_statement_begin__ = 42;
            lp_accum__.add(normal_log<propto__>(y, add(multiply(X_int, beta_int), multiply(X, beta)), sigma_y));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_linear_X_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_int = in__.vector_constrain(n_tree);
        size_t beta_int_j_1_max__ = n_tree;
        for (size_t j_1__ = 0; j_1__ < beta_int_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(y_rep, 
                            ...
                            normal_rng((multiply(get_base1(X_int, i, "X_int", 1), beta_int) + multiply(get_base1(X, i, "X", 1), beta)), sigma_y, base_rng__), 
                            "assigning variable y_rep");
                current_statement_begin__ = 53;
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            normal_log(get_base1(y, i, "y", 1), (multiply(get_base1(X_int, i, "X_int", 1), beta_int) + multiply(get_base1(X, i, "X", 1), beta)), sigma_y), 
            ...
            for (int i = 1; i <= n_pred; ++i) {
                ...
                stan::model::assign(y_pred, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            normal_rng((multiply(get_base1(X_int_pred, i, "X_int_pred", 1), beta_int) + multiply(get_base1(X_pred, i, "X_pred", 1), beta)), sigma_y, base_rng__), 
...
typedef model_linear_X_namespace::model_linear_X stan_model;
#ifndef USING_R
