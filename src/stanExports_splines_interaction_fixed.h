...
namespace model_splines_interaction_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_splines_interaction_fixed");
    reader.add_event(174, 172, "end", "model_splines_interaction_fixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_splines_interaction_fixed
  : public stan::model::model_base_crtp<model_splines_interaction_fixed> {
private:
        int n;
        int K;
        int p;
        ...
        vector_d zeros;
public:
    model_splines_interaction_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_splines_interaction_fixed_namespace::model_splines_interaction_fixed";
    ...
    ~model_splines_interaction_fixed() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= (n_plot - 1); ++j) {
                current_statement_begin__ = 69;
                stan::model::assign(beta0_p_tilde, 
                            stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                            get_base1(beta0_p_tilde_fixed, j, "beta0_p_tilde_fixed", 1), 
                            "assigning variable beta0_p_tilde");
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_splines_interaction_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_splines_interaction_fixed";
    }
...
typedef model_splines_interaction_fixed_namespace::model_splines_interaction_fixed stan_model;
#ifndef USING_R
