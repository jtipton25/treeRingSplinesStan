...
#include "stanExports_linear_fixed_intercept.h"

RCPP_MODULE(stan_fit4linear_fixed_intercept_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_linear_fixed_intercept")
